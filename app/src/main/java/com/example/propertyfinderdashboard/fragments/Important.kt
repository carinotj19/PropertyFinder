...
class Important : Fragment(), ChatAdapter.OnItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = view.findViewById(R.id.important_recycler_view)
    ...
    private fun dataInitialize() {
        ...
        for (i in 0 until 20) {
            val profilePicture = R.drawable.important
            val profileName = faker.job.field()
            val recentMessage = faker.job.position()
