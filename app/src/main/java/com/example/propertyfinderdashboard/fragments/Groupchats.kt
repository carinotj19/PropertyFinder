...
class Groupchats : Fragment(), ChatAdapter.OnItemClickListener {
    ...
    private fun dataInitialize() {
        ...
        for (i in 0 until 20) {
            val profilePicture = R.drawable.group  // Replace with your logic for generating a random image
            val profileName = faker.funnyName.name()
