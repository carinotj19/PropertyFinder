...
class ApprovedPropertySeller : Fragment(), PendingPropertyAdapterSeller.OnClickListener, PropertyAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_approved_property_seller, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView: RecyclerView = view.findViewById(R.id.approvedPropertyRecyclerView)
        recyclerView.layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
        approvedPropertyAdapterSeller = PendingPropertyAdapterSeller(emptyList(), this) // Initialize adapter with empty list
        recyclerView.adapter = approvedPropertyAdapterSeller
    ...
    private fun fetchPropertyData() {
        ...
        propertyCollection.get()
            .addOnSuccessListener { result ->
                ...
                approvedPropertyAdapterSeller.updateData(propertyList)
            }
    ...
    private fun onDelete(item: PropertyModel) {
        ...
        val db = FirebaseFirestore.getInstance()
        val pendingPropertyCollection = db.collection("Properties").document(item.documentId)
    ...
    private fun saveChangesToFirestore(item: PropertyModel) {
        ...
        val db = FirebaseFirestore.getInstance()
        val propertyRef = db.collection("Properties").document(item.documentId)
    ...
    private fun fetchAndUpdateRecyclerView() {
        ...
        pendingPropertyCollection.get()
            .addOnSuccessListener { result ->
                ...
                // Update the adapter with the fetched data
                approvedPropertyAdapterSeller.updateData(updatedPropertyList)
            }
            .addOnFailureListener { exception ->
                // Handle errors
                Log.w(ContentValues.TAG, "Error getting documents.", exception)
